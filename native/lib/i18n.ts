...
const es = {
  ...
  holdToTalk: 'Mantén pulsado y habla',
  recordingNow: 'Te escucho — suelta para enviar',
...
const en: Record<UIKey, string> = {
  ...
  recordingNow: 'Listening — release to send',
...
const it: Record<UIKey, string> = {
  ...
  holdToTalk: 'Tieni premuto e parla',
  recordingNow: 'Ti ascolto — rilascia per inviare',
...
const fr: Record<UIKey, string> = {
  ...
  holdToTalk: 'Maintiens appuyé et parle',
  recordingNow: "Je t'écoute — relâche pour envoyer",
...
const de: Record<UIKey, string> = {
  ...
  holdToTalk: 'Halten und sprechen',
  recordingNow: 'Ich höre zu — loslassen zum Senden',
...
const pt: Record<UIKey, string> = {
  ...
  holdToTalk: 'Mantém premido e fala',
  recordingNow: 'Estou a ouvir — solta para enviar',
